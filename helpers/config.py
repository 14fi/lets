...
class config:
    ...
    def __init__(self, __file):
        ...
        if os.path.isfile(self.fileName):
            ...
            self.default = False
            with open(self.config.get("custom", "config")) as f:
    ...
    def checkConfig(self):
        ...
        try:
            ...
            self.config.get("utsuroi", "enable")
    ...
    def generateDefaultConfig(self):
        ...
        self.config.set("prometheus", "port", "8080")
        ...
        self.config.add_section("utsuroi")
        self.config.set("utsuroi", "enable", "True")
