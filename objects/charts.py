...
class BeatmapChartFailed(Chart):
    ...
    def __init__(self, old_score, new_score,beatmap_id):
        ...
        super(BeatmapChartFailed, self).__init__("beatmap", f"https://{serverurl}/b/{beatmap_id}", "Beatmap Ranking")
        self.rank = 0
...
class OverallChartFailed(Chart):
    ...
    def __init__(self, user_id, old_user_stats, new_user_stats, score, new_achievements, old_rank, new_rank):
        ...
        serverurl = glob.conf.config["server"]["serverurl"]
        super(OverallChartFailed, self).__init__("overall", f"https://{serverurl}/u/{user_id}", "Overall Ranking")
        self.rank = 0
        self.ranked_score = (0, 0)
...
class OverallChart(Chart):
    ...
    def __init__(self, user_id, old_user_stats, new_user_stats, score, new_achievements, old_rank, new_rank):
        ...
        """
        serverurl = glob.conf.config["server"]["serverurl"]
        super(OverallChart, self).__init__("overall", f"https://{serverurl}/u/{user_id}", "Overall Ranking")
